...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { address: @apartment.address, description: @apartment.description, lease_end: @apartment.lease_end, lease_start: @apartment.lease_start, name: @apartment.name, user_id: @apartment.user_id }
    end
  ...
  test "should update apartment" do
    patch :update, id: @apartment, apartment: { address: @apartment.address, description: @apartment.description, lease_end: @apartment.lease_end, lease_start: @apartment.lease_start, name: @apartment.name, user_id: @apartment.user_id }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
